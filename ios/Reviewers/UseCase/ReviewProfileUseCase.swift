...
//        let merchandise = convertMerchindise(firestoreMerchandise: firestoreMerchindise, storageEndpoint: storageEndpoint)
//
//        let imageUrls = firestoreReview.images.map { URL(string: "\(storageEndpoint)/image/user/\(firestoreReview.uid)/\($0)") }
...
//    }
//
//    private func convertMerchindise(firestoreMerchandise: FirestoreMerchandise?, storageEndpoint: String) -> Merchandise? {
//        guard let firestoreMerchandise = firestoreMerchandise else {
//            return nil
//        }
//        return convertUseCaseUtils.firestoreMerchandiseToMerchandise(
//            firestoreMerchandise: firestoreMerchandise,
